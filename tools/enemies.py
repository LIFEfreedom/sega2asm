...
Цвета настоящие. Блок палитры у уровня один (поле `+$00` записи, 128 байт
на все четыре ряда CRAM), а ряд стоит в битах 13-14 имени спрайта — то
есть пара «уровень + кадр» задаёт цвет однозначно. Берётся палитра первого
уровня, где вид водится; разбор и проверка в docs/mauimallard/enemy-catalog.md.
"""
import bisect
import os
import re
