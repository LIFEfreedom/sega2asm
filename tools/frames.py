...
+4   четыре байта: x0, x1, y0, y1 — КОРОБКА в тех же координатах, что и
     куски. Читателя по-прежнему нет, но по данным это именно она: у 554
     кадров ровно с одним куском и без коробок `+4` совпадает с его x в
     94,9 %, `+6` с его y в 93,7 %, а `+5` и `+7` лежат внутри куска в
     95 и 96 %. Исключения осмысленны — у кадров 1101-1104 коробка
