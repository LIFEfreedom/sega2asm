...
TABLES = [
    ...
    # Цепочка в `$1FE1xx`-`$1FE982`: записи (указатель, длительность,
    # режим) ведут на списки клеток, а за ними восемь троек скорости.
    # Границы сошлись сами: списки кончаются на `$1FE952`, тройки —
    # на `$1FE982`, то есть встык с уже разобранной таблицей `$1FE982`.
    (0x1FE100, 0x1FE982 - 0x1FE100, u"общие таблицы"),
